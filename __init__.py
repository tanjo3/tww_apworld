...
class TWWWorld(World):
    ...
    def fill_slot_data(self):
        return {
            "progression_dungeons": self.options.progression_dungeons,
            "progression_tingle_chests": self.options.progression_tingle_chests,
            "progression_dungeon_secrets": self.options.progression_dungeon_secrets,
            "progression_puzzle_secret_caves": self.options.progression_puzzle_secret_caves,
            "progression_combat_secret_caves": self.options.progression_combat_secret_caves,
            "progression_savage_labyrinth": self.options.progression_savage_labyrinth,
            "progression_great_fairies": self.options.progression_great_fairies,
            "progression_short_sidequests": self.options.progression_short_sidequests,
            "progression_long_sidequests": self.options.progression_long_sidequests,
            "progression_spoils_trading": self.options.progression_spoils_trading,
            "progression_minigames": self.options.progression_minigames,
            "progression_battlesquid": self.options.progression_battlesquid,
            "progression_free_gifts": self.options.progression_free_gifts,
            "progression_mail": self.options.progression_mail,
            "progression_platforms_rafts": self.options.progression_platforms_rafts,
            "progression_submarines": self.options.progression_submarines,
            "progression_eye_reef_chests": self.options.progression_eye_reef_chests,
            "progression_big_octos_gunboats": self.options.progression_big_octos_gunboats,
            "progression_triforce_charts": self.options.progression_triforce_charts,
            "progression_treasure_charts": self.options.progression_treasure_charts,
            "progression_expensive_purchases": self.options.progression_expensive_purchases,
            "progression_island_puzzles": self.options.progression_island_puzzles,
            "progression_misc": self.options.progression_misc,
            "randomize_mapcompass": self.options.randomize_mapcompass,
            "randomize_smallkeys": self.options.randomize_smallkeys,
            "randomize_bigkeys": self.options.randomize_bigkeys,
            "sword_mode": self.options.sword_mode,
            "required_bosses": self.options.required_bosses,
            "num_required_bosses": self.options.num_required_bosses,
            "chest_type_matches_contents": self.options.chest_type_matches_contents,
            "trap_chests": self.options.trap_chests,
            "hero_mode": self.options.hero_mode,
            "logic_obscurity": self.options.logic_obscurity,
            "logic_precision": self.options.logic_precision,
            "randomize_dungeon_entrances": self.options.randomize_dungeon_entrances,
            "randomize_secret_cave_entrances": self.options.randomize_secret_cave_entrances,
            "randomize_miniboss_entrances": self.options.randomize_miniboss_entrances,
            "randomize_boss_entrances": self.options.randomize_boss_entrances,
            "randomize_secret_cave_inner_entrances": self.options.randomize_secret_cave_inner_entrances,
            "randomize_fairy_fountain_entrances": self.options.randomize_fairy_fountain_entrances,
            "mix_entrances": self.options.mix_entrances,
            "randomize_enemies": self.options.randomize_enemies,
            # "randomize_music": self.options.randomize_music,
            "randomize_starting_island": self.options.randomize_starting_island,
            "randomize_charts": self.options.randomize_charts,
            "hoho_hints": self.options.hoho_hints,
            "fishmen_hints": self.options.fishmen_hints,
            "korl_hints": self.options.korl_hints,
            "num_item_hints": self.options.num_item_hints,
            "num_location_hints": self.options.num_location_hints,
            "num_barren_hints": self.options.num_barren_hints,
            "num_path_hints": self.options.num_path_hints,
            "cryptic_hints": self.options.cryptic_hints,
            "prioritize_remote_hints": self.options.prioritize_remote_hints,
            "swift_sail": self.options.swift_sail,
            "instant_text_boxes": self.options.instant_text_boxes,
            "reveal_full_sea_chart": self.options.reveal_full_sea_chart,
            "add_shortcut_warps_between_dungeons": self.options.add_shortcut_warps_between_dungeons,
            "skip_rematch_bosses": self.options.skip_rematch_bosses,
            "remove_music": self.options.remove_music,
