...
DUNGEON_SMALL_KEY_COUNTS: dict[str, int] = {"DRC": 4, "FW": 1, "TotG": 2, "ET": 3, "WT": 2}
...
ITEM_TABLE: dict[str, TWWItemData] = {
  ...
  # "Boat's Sail":             TWWItemData("Item",   IC.progression, base_id +   1, 1, 0x803C4C45, 0x78, 0x803C4C5A, 0),
    ...
    "DRC Big Key":             TWWItemData("BigKey",     IC.progression, base_id + 131, 1, None,   None, None,    None),
    "DRC Small Key":           TWWItemData("SmallKey",   IC.progression, base_id + 132, 4, None,     16, None,    None),
    "FW Big Key":              TWWItemData("BigKey",     IC.progression, base_id + 133, 1, None,   None, None,    None),
    "FW Small Key":            TWWItemData("SmallKey",   IC.progression, base_id + 134, 1, None,     8,  None,    None),
    "TotG Big Key":            TWWItemData("BigKey",     IC.progression, base_id + 135, 1, None,   None, None,    None),
    "TotG Small Key":          TWWItemData("SmallKey",   IC.progression, base_id + 136, 2, None,     11, None,    None),
    "ET Big Key":              TWWItemData("BigKey",     IC.progression, base_id + 138, 1, None,   None, None,    None),
    "ET Small Key":            TWWItemData("SmallKey",   IC.progression, base_id + 139, 3, None,     13, None,    None),
    "WT Big Key":              TWWItemData("BigKey",     IC.progression, base_id + 140, 1, None,   None, None,    None),
    "WT Small Key":            TWWItemData("SmallKey",   IC.progression, base_id + 141, 2, None,     9,  None,    None),
    "DRC Dungeon Map":         TWWItemData("DungeonMap", IC.useful,      base_id + 142, 1, None,   None, None,    None),
    "DRC Compass":             TWWItemData("Compass",    IC.useful,      base_id + 143, 1, None,   None, None,    None),
    "FW Dungeon Map":          TWWItemData("DungeonMap", IC.useful,      base_id + 144, 1, None,   None, None,    None),
    "FW Compass":              TWWItemData("Compass",    IC.useful,      base_id + 145, 1, None,   None, None,    None),
    "TotG Dungeon Map":        TWWItemData("DungeonMap", IC.useful,      base_id + 146, 1, None,   None, None,    None),
    "TotG Compass":            TWWItemData("Compass",    IC.useful,      base_id + 147, 1, None,   None, None,    None),
    "FF Dungeon Map":          TWWItemData("DungeonMap", IC.useful,      base_id + 148, 1, None,   None, None,    None),
    "FF Compass":              TWWItemData("Compass",    IC.useful,      base_id + 149, 1, None,   None, None,    None),
    "ET Dungeon Map":          TWWItemData("DungeonMap", IC.useful,      base_id + 150, 1, None,   None, None,    None),
    "ET Compass":              TWWItemData("Compass",    IC.useful,      base_id + 151, 1, None,   None, None,    None),
    "WT Dungeon Map":          TWWItemData("DungeonMap", IC.useful,      base_id + 152, 1, None,   None, None,    None),
    "WT Compass":              TWWItemData("Compass",    IC.useful,      base_id + 153, 1, None,   None, None,    None),
