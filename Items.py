...
ITEM_TABLE: dict[str, TWWItemData] = {
  ...
  # "Boat's Sail":             TWWItemData("Item",    IC.progression,                  1,  1, 0x78),
    ...
    "Triforce Chart 1":        TWWItemData("Chart",   IC.progression_skip_balancing,  63,  1, 0xF7),
    "Triforce Chart 2":        TWWItemData("Chart",   IC.progression_skip_balancing,  64,  1, 0xF8),
    "Triforce Chart 3":        TWWItemData("Chart",   IC.progression_skip_balancing,  65,  1, 0xF9),
    "Triforce Chart 4":        TWWItemData("Chart",   IC.progression_skip_balancing,  66,  1, 0xFA),
    "Triforce Chart 5":        TWWItemData("Chart",   IC.progression_skip_balancing,  67,  1, 0xFB),
    "Triforce Chart 6":        TWWItemData("Chart",   IC.progression_skip_balancing,  68,  1, 0xFC),
    "Triforce Chart 7":        TWWItemData("Chart",   IC.progression_skip_balancing,  69,  1, 0xFD),
    "Triforce Chart 8":        TWWItemData("Chart",   IC.progression_skip_balancing,  70,  1, 0xFE),
    "Treasure Chart 1":        TWWItemData("Chart",   IC.progression_skip_balancing,  71,  1, 0xCC),
    ...
    "Treasure Chart 7":        TWWItemData("Chart",   IC.progression_skip_balancing,  77,  1, 0xE7),
